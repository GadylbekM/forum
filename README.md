...
**In this project you should be able to sign in with your email and password and then log in. Create posts, leave comments, like or dislike. Posts can be filtered according to the category and likes.**
...
```
git@git.01.alem.school:mmedeuba/forum-moderation.git
```
# How to run?
